...
namespace AgOpenGPS
{
    public class CInnerBndPt
    {
        ...
        //constructor
        public CInnerBndPt(double _easting, double _northing, double _heading, bool _passThru = false)
        {
            easting = _easting;
            northing = _northing;
            heading = _heading;
    ...
    public class CInnerBoundary
    {
        ...
        //constructor
        public CInnerBoundary(OpenGL _gl, OpenGL _glb, FormGPS _f)
        {
            mf = _f;
            gl = _gl;
            glb = _glb;
